...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load('game_1\\img\\car.png')
        self.car_x_coordinate = (self.display_width * 0.45)
        self.car_y_coordinate = (self.display_height * 0.8)
        self.car_width = 49

        # enemy_car
        self.enemy_car = pygame.image.load('game_1\\img\\enemy_car_1.png')
        ...
        # Background
        self.bgImg = pygame.image.load("game_1\\img\\back_ground.jpg")
    ...
    def run_car(self):
        ...
        while not self.crashed:
            ...
            # The user clicked the X button in the corner
                    self.crashed=True
                elif event.type == pygame.KEYDOWN:
                    # A key was pressed down
                    if event.key == pygame.K_q:
                        # The q key was pressed, quit the game
                        self.crashed=True
                # print(event)
